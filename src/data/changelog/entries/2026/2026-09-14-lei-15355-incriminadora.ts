...
const entrada: ChangelogEntry = {
  ...
  body: ['A pena é a do caput do art. 32: detenção de 3 meses a 1 ano, e multa.'],
  tipo: 'incriminadora',
  areas: ['Tipos penais'],
  version: 'v0.0.1',
  links: [{label: 'Lei 9.605/98, art. 32, §1º-C', href: 'https://amorim-rc.github.io/sispenas/tipos/1328'}],
};
