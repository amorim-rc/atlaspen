...
const entrada: ChangelogEntry = {
  ...
  body: [
    ...
    'Entram onze frentes: os benefícios penais versionados em dados, a troca do termo "benefícios penais" por "atributos penais", a mudança de nome do projeto, o histórico de alterações de cada registro com a data, o número e o link da lei alteradora, a revisão da ação penal a partir do método de registro, uma amostra qualitativa para validação científica, a separação entre pena cominada e pena concreta na tela, o acervo histórico das alterações da lei penal desde o Código Penal de 1940, a numeração das versões até o lançamento oficial e o preparo do repositório para o trabalho em grupo. O que o roadmap ainda tinha em aberto foi levado junto, sem perda.',
    'A regra de versionamento, que diz quando uma versão é MAIOR, MENOR ou correção, está agora na seção Estabilidade e versionamento da página Dados abertos. É ali que mora o contrato com quem usa os dados.',
