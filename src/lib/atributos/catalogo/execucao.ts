...
export const progressao: AtributoDef = {
  ...
  parametros: [
    ...
    },
    {
      ...
      fundamento: 'Art. 112, V, LEP (redação da Lei 15.358/2026)',
    },
    {
      ...
      max: 1,
      passo: 0.01,
      ajuda: 'Inciso VI: 75% da pena, vedado o livramento condicional. Era 50% até a Lei 15.358/2026, que também acrescentou a alínea "d" (feminicídio, se primário).',
    ...
    },
    {
      ...
      max: 1,
      passo: 0.01,
      ajuda: 'Inciso VII: 80% da pena para o reincidente na prática de crime hediondo ou equiparado. Era 60% até a Lei 15.358/2026.',
      fundamento: 'Art. 112, VII, LEP (redação da Lei 15.358/2026)',
    },
    {
      ...
      max: 1,
      passo: 0.01,
      ajuda: 'Inciso VIII: 85% da pena, vedado o livramento condicional. Era 70% até a Lei 15.358/2026.',
      fundamento: 'Art. 112, VIII, LEP (redação da Lei 15.358/2026)',
    },
  ],
  avaliar: (c, p) => {
