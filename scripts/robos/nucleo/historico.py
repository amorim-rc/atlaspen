...
`data/historico-legislativo.json` (.superpowers/specs/2026-09-10-modelo-atributos.md, seção 4.5).
...
META = {
    "descricao": (
        ...
        "vida de cada dispositivo, em ordem cronológica (.superpowers/specs/2026-09-10-modelo-atributos.md, "
